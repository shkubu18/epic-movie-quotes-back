...
<table align="center" style="max-width: 1250px; min-width: 300px; padding: 80px 20px 0 20px;; height: 100%; color: white">
    ...
    <tr>
        <td align="left" valign="top">
            ...
            <br>
            <a href="{{ env('FRONTEND_URL') . '/?token=' . $token }}" style="text-decoration: none; color: white; background: #E31221; padding: 10px; border-radius: 4px;">Update password</a>
            <br>
            <br>
            <p style="margin: 40px 0">If clicking doesn't work, you can try copying and pasting it to your browser:</p>
            <p style="margin: 0; word-break: break-all; color:  #DDCCAA;">{{ env('FRONTEND_URL') . '/?token=' . $token }}</p>
            <br>
